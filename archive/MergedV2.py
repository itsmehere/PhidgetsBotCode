...
def GUI_update_clock():
    ...
    global PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject_2
    global BLDC_OPEN_FLAG_2
    global SHOW_IN_GUI_BLDC_FLAG_2
    ...
    if USE_GUI_FLAG == 1:
        ...
        #########################################################
            ...
            #########################################################
            if BLDC_OPEN_FLAG_2 == 1 and SHOW_IN_GUI_BLDC_FLAG_2 == 1:
                PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject_2.GUI_update_clock()
            #########################################################
...
def ExitProgram_Callback():
    ...
    #########################################################
    if BLDC_OPEN_FLAG_2 == 1:
        PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject_2.ExitProgram_Callback()
    #########################################################
...
if __name__ == '__main__':
    ...
    global USE_BLDC_FLAG_2
    USE_BLDC_FLAG_2 = 0

    global USE_BLDC_POSITION_CONTROL_FLAG_2
    USE_BLDC_POSITION_CONTROL_FLAG_2 = 1 #SET TO 0 FOR VELOCITY CONTROL

    global USE_BLDC_SINUSOIDAL_INPUT_FLAG_2
    USE_BLDC_SINUSOIDAL_INPUT_FLAG_2 = 1
    ...
    global GUI_ROW_BLDC_2
    global GUI_COLUMN_BLDC_2
    global GUI_PADX_BLDC_2
    global GUI_PADY_BLDC_2
    global GUI_ROWSPAN_BLDC_2
    global GUI_COLUMNSPAN_BLDC_2
    GUI_ROW_BLDC_2 = 2

    GUI_COLUMN_BLDC_2 = 0
    GUI_PADX_BLDC_2 = 1
    GUI_PADY_BLDC_2 = 10
    GUI_ROWSPAN_BLDC_2 = 1
    GUI_COLUMNSPAN_BLDC_2 = 1
    ...
    global SINUSOIDAL_MOTION_INPUT_MinValue_PositionControl_2
    SINUSOIDAL_MOTION_INPUT_MinValue_PositionControl_2 = -50.0

    global SINUSOIDAL_MOTION_INPUT_MaxValue_PositionControl_2
    SINUSOIDAL_MOTION_INPUT_MaxValue_PositionControl_2 = 50.0

    global SINUSOIDAL_MOTION_INPUT_MinValue_VelocityControl_2
    SINUSOIDAL_MOTION_INPUT_MinValue_VelocityControl_2 = -1.0

    global SINUSOIDAL_MOTION_INPUT_MaxValue_VelocityControl_2
    SINUSOIDAL_MOTION_INPUT_MaxValue_VelocityControl_2 = 1.0
    ...
    global BLDC_MostRecentDict_2

    global BLDC_MostRecentDict_Position_PhidgetsUnits_FromDevice_2
    BLDC_MostRecentDict_Position_PhidgetsUnits_FromDevice_2 = -11111

    global BLDC_MostRecentDict_Velocity_PhidgetsUnits_FromDevice_2
    BLDC_MostRecentDict_Velocity_PhidgetsUnits_FromDevice_2 = -11111

    global BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedRaw_2
    BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedRaw_2 = -11111

    global BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedSmoothed_2
    BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedSmoothed_2 = -11111

    global BLDC_MostRecentDict_DutyCycle_PhidgetsUnits_FromDevice_2
    BLDC_MostRecentDict_DutyCycle_PhidgetsUnits_FromDevice_2 = -11111

    global BLDC_MostRecentDict_Temperature_DegC_FromDevice_2
    BLDC_MostRecentDict_Temperature_DegC_FromDevice_2 = -11111

    global BLDC_MostRecentDict_Time_2
    BLDC_MostRecentDict_Time_2 = -11111

    #################################################
    BLDC_GUIparametersDict_2 = dict([("USE_GUI_FLAG", USE_GUI_FLAG and SHOW_IN_GUI_BLDC_FLAG_2),
                                    ("root", root),
                                    ("EnableInternal_MyPrint_Flag", 1),
                                    ("NumberOfPrintLines", 10),
                                    ("UseBorderAroundThisGuiObjectFlag", 0),
                                    ("GUI_ROW", GUI_ROW_BLDC_2),
                                    ("GUI_COLUMN", GUI_COLUMN_BLDC_2),
                                    ("GUI_PADX", GUI_PADX_BLDC_2),
                                    ("GUI_PADY", GUI_PADY_BLDC_2),
                                    ("GUI_ROWSPAN", GUI_ROWSPAN_BLDC_2),
                                    ("GUI_COLUMNSPAN", GUI_COLUMNSPAN_BLDC_2)])
    #################################################

    #################################################
    global BLDC_setup_dict_PositionControl_2
    BLDC_setup_dict_PositionControl_2 = dict([("GUIparametersDict", BLDC_GUIparametersDict_2),
                            ("UsePhidgetsLoggingInternalToThisClassObjectFlag", 1),
                            ("WaitForAttached_TimeoutDuration_Milliseconds", 5000),
                            ("user_set_name", "Reuben's Test BLDC Controller"),
                            ("VINT_DesiredSerialNumber", 634222), #CHANGE THIS TO MATCH YOUR UNIQUE VINT
    ...
    #################################################
    global BLDC_setup_dict_VelocityControl_2
    BLDC_setup_dict_VelocityControl_2 = dict([("GUIparametersDict", BLDC_GUIparametersDict_2),
                            ("UsePhidgetsLoggingInternalToThisClassObjectFlag", 1),
                            ("WaitForAttached_TimeoutDuration_Milliseconds", 5000),
                            ("user_set_name", "Reuben's Test BLDC Controller"),
                            ("VINT_DesiredSerialNumber", 634222), #CHANGE THIS TO MATCH YOUR UNIQUE VINT
    ...
    if USE_BLDC_FLAG_2 == 1:
        try:

            if USE_BLDC_POSITION_CONTROL_FLAG_2 == 1:
                PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject_2 = PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3Class(BLDC_setup_dict_PositionControl_2)

            else:
                PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject_2 = PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3Class(BLDC_setup_dict_VelocityControl_2)

            time.sleep(0.25)
            BLDC_OPEN_FLAG_2 = PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject.OBJECT_CREATED_SUCCESSFULLY_FLAG

        except:
            exceptions = sys.exc_info()[0]
            print("PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject_2 __init__: Exceptions: %s" % exceptions, 0)
            traceback.print_exc()
    ...
    if USE_BLDC_FLAG_2 == 1 and BLDC_OPEN_FLAG_2 != 1:
        print("Failed to open PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3Class_2.")
        input("Press any key (and enter) to exit.")
        sys.exit()
    ...
    while(EXIT_PROGRAM_FLAG == 0):
        ...
        if USE_BLDC_FLAG_2 == 1:
            ######################### GETs
            BLDC_MostRecentDict_2 = PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject_2.GetMostRecentDataDict()

            BLDC_MostRecentDict_Position_PhidgetsUnits_FromDevice_2 = BLDC_MostRecentDict_2["Position_PhidgetsUnits_FromDevice"]
            BLDC_MostRecentDict_Velocity_PhidgetsUnits_FromDevice_2 = BLDC_MostRecentDict_2["Velocity_PhidgetsUnits_FromDevice"]
            BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedRaw_2 = BLDC_MostRecentDict_2["Velocity_PhidgetsUnits_DifferentiatedRaw"]
            BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedSmoothed_2 = BLDC_MostRecentDict_2["Velocity_PhidgetsUnits_DifferentiatedSmoothed"]
            BLDC_MostRecentDict_DutyCycle_PhidgetsUnits_FromDevice_2 = BLDC_MostRecentDict_2["DutyCycle_PhidgetsUnits_FromDevice"]
            BLDC_MostRecentDict_Temperature_DegC_FromDevice_2 = BLDC_MostRecentDict_2["Temperature_DegC_FromDevice"]
            BLDC_MostRecentDict_Time_2 = BLDC_MostRecentDict_2["Time"]

            #print("BLDC_MostRecentDict_Position_PhidgetsUnits_FromDevice: " + str(BLDC_MostRecentDict_Position_PhidgetsUnits_FromDevice_2))
            #print("BLDC_MostRecentDict_Velocity_PhidgetsUnits_FromDevice: " + str(BLDC_MostRecentDict_Velocity_PhidgetsUnits_FromDevice_2))
            #print("BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedRaw: " + str(BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedRaw_2))
            #print("BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedSmoothed: " + str(BLDC_MostRecentDict_Velocity_PhidgetsUnits_DifferentiatedSmoothed_2))
            #print("BLDC_MostRecentDict_DutyCycle_PhidgetsUnits_FromDevice: " + str(BLDC_MostRecentDict_DutyCycle_PhidgetsUnits_FromDevice_2))
            #print("BLDC_MostRecentDict_Temperature_DegC_FromDevice: " + str(BLDC_MostRecentDict_Temperature_DegC_FromDevice_2))
            #print("BLDC_MostRecentDict_Time: " + str(BLDC_MostRecentDict_Time_2))
            ...
            if USE_BLDC_SINUSOIDAL_INPUT_FLAG_2 == 1:

                if USE_BLDC_POSITION_CONTROL_FLAG_2 == 1:
                    SINUSOIDAL_INPUT_TO_COMMAND_2 = (SINUSOIDAL_MOTION_INPUT_MaxValue_PositionControl_2 + SINUSOIDAL_MOTION_INPUT_MinValue_PositionControl_2)/2.0 + 0.5*abs(SINUSOIDAL_MOTION_INPUT_MaxValue_PositionControl_2 - SINUSOIDAL_MOTION_INPUT_MinValue_PositionControl_2)*math.sin(time_gain*CurrentTime_MainLoopThread)
                    PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject_2.CommandMotorFromExternalProgram_PositionControl(-1.0*SINUSOIDAL_INPUT_TO_COMMAND_2)

                else:
                    SINUSOIDAL_INPUT_TO_COMMAND_2 = (SINUSOIDAL_MOTION_INPUT_MaxValue_VelocityControl_2 + SINUSOIDAL_MOTION_INPUT_MinValue_VelocityControl_2)/2.0 + 0.5*abs(SINUSOIDAL_MOTION_INPUT_MaxValue_VelocityControl_2 - SINUSOIDAL_MOTION_INPUT_MinValue_VelocityControl_2)*math.sin(time_gain*CurrentTime_MainLoopThread)
                    PhidgetBrushlessDCmotorDCC1100controller_ReubenPython2and3ClassObject_2.CommandMotorFromExternalProgram_VelocityControl(-1.0 * SINUSOIDAL_INPUT_TO_COMMAND_2)
            #########################
